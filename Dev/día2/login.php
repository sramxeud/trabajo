    ...
    if (empty($error_contra)) {
        ...
        if (mysqli_num_rows($result) == 0) {
            ...
            if (mysqli_num_rows($result) == 1) {
                ...
                $query = "INSERT INTO login_attempts (nombre, fecha, ip, exito) VALUES ('$nombre', NOW(), '$ip_pc', 1)";
                ...
                $query = "INSERT INTO login_attempts (nombre, fecha, ip, exito) VALUES ('$nombre', NOW(), '$ip_pc', 0)";
                mysqli_query($link, $query);
            }
        }
    } else {
